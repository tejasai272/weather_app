...
if (navigator.geolocation) {
	...
	function getCurrentLocation (position) {
		...
		$.getJSON("http://api.openweathermap.org/data/2.5/weather?lat=" + latitude + "&lon=" + longitude + "&APPID=f7a501e23756f461faa55e2ebda3d581", function (data) {
	...
	$("form").on("submit", function(event) {
		...
		$.getJSON("http://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=f7a501e23756f461faa55e2ebda3d581", function (data) {
			var rawJson = JSON.stringify(data);
			var json = JSON.parse(rawJson);
			updateWeather(json); //Update Weather parameters
		});
